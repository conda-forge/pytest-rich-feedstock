...
Once the `conda-forge` channel has been enabled, `pytest-rich` can be installed with:

```
conda install pytest-rich
```

It is possible to list all of the versions of `pytest-rich` available on your platform with:
